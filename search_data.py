...
def search_data_from_html(page, html):
    ...
    if get_mobile_name:
        ...
        print(f"處理 mobile_name={mobile_name}")
    ...
    for step in step_list:
        ...
        if index == '3' and '4[log]Ip Address' in text:
            screenshot(page, index, text, 'inet 10.0.0.', mobile_name)

        elif index == '4' and '5[log]SSID' in text:
            screenshot(page, index, text, 'SSID: ', mobile_name)
        
        elif index == '6' and '7[log]Ping Test' in text:
            screenshot(page, index, text, 'PING 8.8.8.8 (8.8.8.8)', mobile_name)

        elif index == '8' and '9[log]Ping Test' in text:
            screenshot(page, index, text, 'PING www.google.com', mobile_name)
        
            break

def screenshot(page, index, text, keyword, mobile_name):
    ...
    if keyword in ping_test_2.inner_text():
        ...
        page.screenshot(path=f"{folder_path}/{mobile_name}.png")
        print(f"處理 index={index} → {folder_name}")
